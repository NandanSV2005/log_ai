    ...
    try {
      ...
      try {
        ...
        if (response.status === 429) {
          errorDetail = errorData.detail || errorData.error || 'Too many attempts. Please wait a minute before trying again.';
        ...
        if (response.status === 429) {
          errorDetail = 'Too many attempts. Please wait a minute before trying again.';
        } else if (text) {
          errorDetail = text;
        }
      }
